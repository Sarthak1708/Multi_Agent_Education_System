...
HF_API_KEY = "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"
...
def _generate_single_image(topic: str):
    try:
        prompt = (
            f"A professional educational diagram explaining {topic}. "
            f"Clean white background, simple shapes and arrows showing the concept. "
            f"Flat design infographic style, structured layout. "
            f"No text, no words, no letters. No people. "
            f"Only visual elements, icons, shapes, and arrows."
        )
